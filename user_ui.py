...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.statusLabel = QLabel(self.topFrame)
        ...
        self.soundCheckBox.setFont(font1)
...
"")
        ...
        self.carListFrame.setFrameShape(QFrame.Shape.NoFrame)
        self.carListFrame.setFrameShadow(QFrame.Shadow.Plain)
        self.gridLayout_4 = QGridLayout(self.carListFrame)
        self.gridLayout_4.setObjectName(u"gridLayout_4")
        self.availablePlainTextEdit = QPlainTextEdit(self.carListFrame)
        self.availablePlainTextEdit.setObjectName(u"availablePlainTextEdit")
        sizePolicy2 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.availablePlainTextEdit.sizePolicy().hasHeightForWidth())
        self.availablePlainTextEdit.setSizePolicy(sizePolicy2)
        font2 = QFont()
        font2.setPointSize(12)
        font2.setBold(True)
        self.availablePlainTextEdit.setFont(font2)
...
"")
        ...
        self.gridLayout_4.addWidget(self.availablePlainTextEdit, 1, 0, 1, 1)

        self.availableLabel = QLabel(self.carListFrame)
        ...
        self.gridLayout_4.addWidget(self.availableLabel, 0, 0, 1, 1)

        self.inUsePlainTextEdit = QPlainTextEdit(self.carListFrame)
        self.inUsePlainTextEdit.setObjectName(u"inUsePlainTextEdit")
        sizePolicy2.setHeightForWidth(self.inUsePlainTextEdit.sizePolicy().hasHeightForWidth())
        self.inUsePlainTextEdit.setSizePolicy(sizePolicy2)
        self.inUsePlainTextEdit.setFont(font2)
...
"border-color: rgb(255, 255, 255);")
        ...
        self.gridLayout_4.addWidget(self.inUsePlainTextEdit, 1, 3, 1, 1)

        self.inUseLabel = QLabel(self.carListFrame)
        ...
        self.gridLayout_4.addWidget(self.inUseLabel, 0, 3, 1, 1)

        self.line_2 = QFrame(self.carListFrame)
        self.line_2.setObjectName(u"line_2")
        sizePolicy.setHeightForWidth(self.line_2.sizePolicy().hasHeightForWidth())
        self.line_2.setSizePolicy(sizePolicy)
        self.line_2.setMaximumSize(QSize(3, 16777215))
        ...
        self.topButtonFrame.setFrameShape(QFrame.Shape.NoFrame)
...
"background-color: rgb(140, 51, 85);")
        ...
        self.reasonFrame.setMaximumSize(QSize(1900, 80))
        self.reasonFrame.setFrameShape(QFrame.Shape.NoFrame)
        ...
        sizePolicy1.setHeightForWidth(self.reasonComboBox.sizePolicy().hasHeightForWidth())
        self.reasonComboBox.setSizePolicy(sizePolicy1)
...
"color: rgb(32, 75, 70);")
        ...
        self.lendPageMainFrame.setFrameShape(QFrame.Shape.NoFrame)
        ...
        self.carRegisterFrame.setFrameShape(QFrame.Shape.NoFrame)
        ...
        self.timeFrame.setFrameShape(QFrame.Shape.NoFrame)
        ...
        sizePolicy1.setHeightForWidth(self.calendarLabel.sizePolicy().hasHeightForWidth())
        self.calendarLabel.setSizePolicy(sizePolicy1)
        ...
        self.lenderInfoFrame.setFrameShape(QFrame.Shape.NoFrame)
        ...
        self.ssnLineEdit.setFont(font9)
...
"color: rgb(32, 75, 70);")
        ...
        sizePolicy1.setHeightForWidth(self.returnCarFrame.sizePolicy().hasHeightForWidth())
        self.returnCarFrame.setSizePolicy(sizePolicy1)
        self.returnCarFrame.setMaximumSize(QSize(300, 300))
        self.returnCarFrame.setFrameShape(QFrame.Shape.NoFrame)
