...
"")
        ...
        sizePolicy1.setHeightForWidth(self.availablePlainTextEdit.sizePolicy().hasHeightForWidth())
        self.availablePlainTextEdit.setSizePolicy(sizePolicy1)
        font1 = QFont()
        font1.setPointSize(12)
        font1.setBold(True)
        self.availablePlainTextEdit.setFont(font1)
...
"")
        ...
        font2.setBold(True)
        self.availableLabel.setFont(font2)
        ...
        sizePolicy1.setHeightForWidth(self.inUsePlainTextEdit.sizePolicy().hasHeightForWidth())
        self.inUsePlainTextEdit.setSizePolicy(sizePolicy1)
        self.inUsePlainTextEdit.setFont(font1)
