...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.topFrame.setMaximumSize(QSize(16777215, 16777215))
...
"")
        ...
        self.stackedWidget.setMinimumSize(QSize(300, 300))
...
"background-color: rgb(140, 51, 85);")
        ...
        self.gridLayout_9.addItem(self.horizontalSpacer_10, 1, 4, 1, 1)

        self.timeFrame = QFrame(self.frame_2)
        self.timeFrame.setObjectName(u"timeFrame")
        sizePolicy2.setHeightForWidth(self.timeFrame.sizePolicy().hasHeightForWidth())
        self.timeFrame.setSizePolicy(sizePolicy2)
        self.timeFrame.setMinimumSize(QSize(300, 300))
        self.timeFrame.setMaximumSize(QSize(300, 300))
        ...
        self.dateLabel.setMinimumSize(QSize(350, 50))
        ...
        self.timeLabel.setMinimumSize(QSize(350, 0))
        ...
        self.gridLayout_9.addWidget(self.timeFrame, 1, 3, 1, 1)

        self.carRegisterFrame = QFrame(self.frame_2)
        self.carRegisterFrame.setObjectName(u"carRegisterFrame")
        sizePolicy2.setHeightForWidth(self.carRegisterFrame.sizePolicy().hasHeightForWidth())
        self.carRegisterFrame.setSizePolicy(sizePolicy2)
        self.carRegisterFrame.setMinimumSize(QSize(300, 300))
        self.carRegisterFrame.setMaximumSize(QSize(300, 300))
        ...
        sizePolicy5.setHeightForWidth(self.keyPictureLabel.sizePolicy().hasHeightForWidth())
        self.keyPictureLabel.setSizePolicy(sizePolicy5)
        ...
        self.gridLayout_5.addWidget(self.keyPictureLabel, 1, 0, 1, 1)
        ...
        self.registerPlateBGLabel.setMinimumSize(QSize(0, 0))
        self.registerPlateBGLabel.setMaximumSize(QSize(180, 50))
        ...
        self.keyBarcodeLineEdit.setMinimumSize(QSize(0, 0))
        self.keyBarcodeLineEdit.setMaximumSize(QSize(180, 50))
        font6 = QFont()
        ...
        self.gridLayout_9.addWidget(self.carRegisterFrame, 1, 2, 1, 1)

        self.carInfoFrame = QFrame(self.frame_2)
        self.carInfoFrame.setObjectName(u"carInfoFrame")
        sizePolicy2.setHeightForWidth(self.carInfoFrame.sizePolicy().hasHeightForWidth())
        self.carInfoFrame.setSizePolicy(sizePolicy2)
        self.carInfoFrame.setMinimumSize(QSize(300, 300))
        self.carInfoFrame.setMaximumSize(QSize(300, 300))
        ...
        sizePolicy5.setHeightForWidth(self.vehiclePictureLabel.sizePolicy().hasHeightForWidth())
        self.vehiclePictureLabel.setSizePolicy(sizePolicy5)
        ...
        self.carInfoLabel.setMaximumSize(QSize(300, 50))
        font7 = QFont()
        ...
        self.gridLayout_9.addWidget(self.carInfoFrame, 2, 2, 1, 1)

        self.verticalSpacer_3 = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.gridLayout_9.addItem(self.verticalSpacer_3, 3, 2, 1, 1)
        ...
        sizePolicy2.setHeightForWidth(self.lenderInfoFrame.sizePolicy().hasHeightForWidth())
        self.lenderInfoFrame.setSizePolicy(sizePolicy2)
        self.lenderInfoFrame.setMinimumSize(QSize(300, 300))
        self.lenderInfoFrame.setMaximumSize(QSize(300, 300))
        ...
        sizePolicy5.setHeightForWidth(self.lenderPictureLabel.sizePolicy().hasHeightForWidth())
        self.lenderPictureLabel.setSizePolicy(sizePolicy5)
        ...
        self.ssnLineEdit.setMaximumSize(QSize(300, 50))
        font8 = QFont()
...
"color: rgb(32, 75, 70);")
        ...
        self.gridLayout_9.addWidget(self.lenderInfoFrame, 1, 1, 1, 1)

        self.verticalSpacer_4 = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.gridLayout_9.addItem(self.verticalSpacer_4, 0, 2, 1, 1)
        ...
        self.frame.setMinimumSize(QSize(600, 80))
        ...
        font9.setBold(True)
        self.reasonComboBox.setFont(font9)
...
"color: rgb(32, 75, 70);")
        ...
        sizePolicy6.setHeightForWidth(self.keyReturnBarcodeLineEdit.sizePolicy().hasHeightForWidth())
        self.keyReturnBarcodeLineEdit.setSizePolicy(sizePolicy6)
        ...
        sizePolicy7.setHeightForWidth(self.okPushButton.sizePolicy().hasHeightForWidth())
        self.okPushButton.setSizePolicy(sizePolicy7)
...
"color: rgb(255, 255, 255);")
        ...
        sizePolicy7.setHeightForWidth(self.goBackPushButton.sizePolicy().hasHeightForWidth())
        self.goBackPushButton.setSizePolicy(sizePolicy7)
